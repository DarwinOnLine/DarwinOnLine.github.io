...
qu'on donne à un ordinateur. Ces instructions, on appelle ça du **code**.

Et comme un maçon a ses outils, moi j'ai les miens. Sauf que les miens sont invisibles.
...
La différence, c'est que l'ordinateur est le commis de cuisine le plus discipliné et le plus stupide du monde.
Appelons-le Régis. Régis fait **exactement** ce que tu lui dis. Pas plus, pas moins. Si tu oublies de lui dire 
...
## Internet, c'est de la plomberie

Quand tu ouvres ton navigateur et que tu tapes une adresse, il se passe en gros la même chose que quand tu ouvres le
robinet.

Derrière ton robinet, il y a des kilomètres de tuyaux, un château d'eau, une station de traitement, des pompes,
des vannes. Tu ne vois rien de tout ça. Tu tournes le robinet, l'eau coule.
Et si elle ne coule plus, tu appelles le plombier.

Internet, c'est pareil. Derrière un site web, il y a des **serveurs** (des gros ordinateurs qui ne dorment jamais),
des **câbles** (parfois au fond de l'océan, littéralement), des **protocoles** (des règles pour que tout ce beau monde
...
mais la version courte pour Maman, c'est simple.

L'IA, c'est un outil. Un outil très puissant, certes. Imaginez un assistant qui peut écrire des bouts de recettes de
cuisine à votre place, très vite. C'est impressionnant. Mais cet assistant ne sait pas si le gratin est bon.
